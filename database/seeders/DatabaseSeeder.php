...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        // 1. Kosongkan tabel agar tidak terjadi duplikasi saat di-seed ulang
        ...
        $ikuData = [
            ...
            [
                ...
                'target_2026' => 52.05,
                'satuan' => '%',
                'keterangan' => 'Target AEE khusus D3',
            ],
            [
                'kode_iku' => 'IKU 1_S1',
                ...
                'target_2026' => 60.41,
                'satuan' => '%',
                'keterangan' => 'Target AEE khusus S1',
            ],
            [
                'kode_iku' => 'IKU 1_S2',
                ...
                'target_2026' => 41.02,
                'satuan' => '%',
                'keterangan' => 'Target AEE khusus S2',
            ],
            [
                'kode_iku' => 'IKU 1_S3',
                'nama_iku' => 'AEE - Doktor',
                ...
                'target_2026' => 35.05,
                'satuan' => '%',
                'keterangan' => 'Target AEE khusus S3',
            ],
            [
                'kode_iku' => 'IKU 2',
                ...
                'target_2026' => 73.00,
                'satuan' => '%',
                'keterangan' => 'Status lulusan 1 tahun setelah lulus',
            ],
            [
                'kode_iku' => 'IKU 3',
                ...
                'target_2026' => 30.00,
                'satuan' => '%',
                'keterangan' => 'Berdasarkan tabel sasaran program utama',
            ],
            [
                'kode_iku' => 'IKU 4',
        ...
        // 1. AEE D3 (IKU 1_D3) - Sumber: PDF Halaman 6
        $aeeD3Fakultas = [
        ...
        foreach ($aeeD3Fakultas as $data) {
            DB::table('target_fakultas')->insert([
                ...
                'baseline_2025' => $data['baseline_2025'],
        ...
        // 2. AEE S1 (IKU 1_S1) - Sumber: PDF Halaman 8 & 9
        $aeeS1Fakultas = [
        ...
        // 5. IKU 6 - Sumber: PDF Halaman 27 (Koreksi kolom target 2026)
        $iku6Fakultas = [
            ...
            ['fakultas' => 'SPS', 'target_2026' => 39], // Sekolah Pascasarjana
        ];
